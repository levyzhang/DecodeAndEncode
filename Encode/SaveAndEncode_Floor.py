...
class DataCollector:
    def __init__(self, image_topic, thermal_image_topic, pointcloud_topic, odometry_topic, save_dir, time_tolerance=0.1):
        ...
        self.floor_value = 0  # Default floor value
        ...
        floor_sub = rospy.Subscriber("/floor", Int32, self.floor_callback)  # Subscribe to the floor topic
    ...
    def floor_callback(self, msg):
        # Update floor value when a new message is received
        self.floor_value = msg.data
        rospy.loginfo("Received floor value: {}".format(self.floor_value))
    ...
    def generate_json(self, points_3d, points_2d):
        ...
        # Use the received floor value instead of a fixed value
        ...
        self.json_data = OrderedDict([
            ...
            ("pos_yaw", pos_yaw),
            ("floor", floor),  # Now using dynamic floor value
